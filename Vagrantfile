...
Vagrant::Config.run do |config|
	...
	# As an alternative to vivid32, VMs can be built from the 'django-base' box as defined at
	...
	config.vm.share_folder "project", "/home/vagrant/digital-manifesto", "."
	
	# Enable provisioning with a shell script.
	config.vm.provision :shell, :path => "etc/install/install.sh", :args => "digital-manifesto"
end
